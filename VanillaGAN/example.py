"""
Implementing Generative Adversarial Network of simple version
(http://blog.aylien.com/introduction-generative-adversarial-networks-code-tensorflow/)
(code: https://github.com/AYLIEN/gan-intro/blob/master/gan.py)
"""
...
class GAN(object):
    def __init__(self, params):
        # This defines the generator network - it takes samples from a noise distribution
        ...
        # The discriminator tries to tell the difference between sample from
    ...
    with tf.Session() as session:
        ...
        for step in range(params.num_steps + 1):
            ...
            if params.anim_path and (step % params.anim_every == 0):
                anim_frames.append(
                    samples(model, session, data, gen.range, params.batch_size, num_points=1000)
                )
        ...
        if params.anim_path:
            ...
            plot_distribution(samps, gen.range)
...
def plot_distribution(samps, sample_range):
    db, pd, pg = samps
...
def parse_args():
    ...
    parser.add_argument('--anim-path', type=str, default='./ret.mp4',
