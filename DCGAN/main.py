...
flags.DEFINE_float('beta1', 0.5, 'Momentum of ADAM [0.5]')
flags.DEFINE_integer('train_size', np.inf, 'The size of train images [np.inf]')
flags.DEFINE_integer('batch_size', 64, 'The size of batch images [64]')
flags.DEFINE_integer('input_height', 108, 'The height of image to use (will be center cropped). [108]')
flags.DEFINE_integer('input_width', None, 'The width of image to use (will be center cropped). '
                                          'If None, same value as input_height')
flags.DEFINE_integer('output_height', 64, 'The height of the output images to produce [64]')
flags.DEFINE_integer('output_width', None, 'The width of the output images to produce.'
